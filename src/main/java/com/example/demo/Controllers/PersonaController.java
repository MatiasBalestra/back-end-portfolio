...
public class PersonaController {
        ...
        public ResponseEntity<?> update(@PathVariable("id") Long id, @RequestBody Persona perso) {
            ...
            dom_persona.setTwitter(perso.getTwitter());
            dom_persona.setInstagram(perso.getInstagram());
            dom_persona.setLinkedin(perso.getLinkedin());
            dom_persona.setGithub(perso.getGithub());
            dom_persona.setTelefono(perso.getTelefono());
